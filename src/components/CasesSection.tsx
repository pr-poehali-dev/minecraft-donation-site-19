...
const survivalCases: Case[] = [
  {
    id: 'privilege_universal',
    name: 'Донатный кейс',
    price: 100,
    icon: 'Package',
    color: 'from-purple-600 to-pink-600',
    description: 'Шанс получить любую привилегию',
    rewards: [
      'Привилегия LITE (89%)',
      'Привилегия WARRIOR (7%)',
      'Привилегия ELITE (2%)',
      'Привилегия TITAN (1%)',
      'Привилегия MASTER (0.5%)',
      'Привилегия LEGEND (0.25%)',
      'Привилегия OVERLORD (0.15%)',
      'Привилегия PHOENIX (0.09%)',
      'Привилегия YOUTUBE (0.01%)'
    ]
  }
];
